...
def setup_db():
    ...
    try:
        ...
        # Drop PROCEDURE
        cursor.execute("DROP PROCEDURE IF EXISTS SpManagePurchaseRequisition")
        ...
        BEGIN
            ...
            IF p_Action = 'CREATE' THEN
                ...
                INSERT INTO PurchaseRequisition (
                    DocNo, DocDate, Status, Plant, Version, Remarks, Attachments, Comments,
                ...
                SELECT 
                    v_PrId, jt.itemCode, jt.itemName, jt.uom, jt.qty, jt.qtyOrdered,
                ...
                INSERT INTO ApprovalStep (
                    PurchaseRequisitionId, Level, Role, Approver, Status, ActedAt, Remarks, CreatedBy, CreatedDate
                )
                SELECT 
                    v_PrId, jt.level, jt.role, jt.approver, jt.status, 
                ...
                WHERE pr.Id = v_PrId AND pr.IsDeleted = 0;
