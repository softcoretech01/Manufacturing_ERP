...
class QualityParameterRepository:
    ...
    async def get_next_code(self) -> Dict[str, str]:
        query = text("CALL SpGetNextQualityParameterCode()")
        result = await self.db.execute(query)
        row = result.fetchone()
        return {"nextCode": row.nextCode}

    async def get_all(self) -> List[Dict[str, Any]]:
        query = text("CALL SpQualityParameter('LIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)")
        result = await self.db.execute(query)
        return [self._row_to_dict(row) for row in result.fetchall()]

    async def get_by_id(self, uid: str) -> Dict[str, Any]:
        query = text("CALL SpQualityParameter('READ', :uid, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)")
    ...
    async def create(self, uid: str, data: Dict[str, Any], current_user: str) -> Dict[str, Any]:
        query = text("""
            CALL SpQualityParameter(
                'CREATE', :uid, :code, :name, :paramType, :stage, 
                :nominal, :tolerance, :uom, :instrument, :isCritical, :method, 
    ...
    async def update(self, uid: str, data: Dict[str, Any], current_user: str) -> Dict[str, Any]:
        query = text("""
            CALL SpQualityParameter(
                'UPDATE', :uid, :code, :name, :paramType, :stage, 
                :nominal, :tolerance, :uom, :instrument, :isCritical, :method, 
                :effectiveFrom, :effectiveTo, :isActive, :modifiedBy
            )
        """)
    ...
    async def delete(self, uid: str, current_user: str) -> None:
        query = text("CALL SpQualityParameter('DELETE', :uid, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, :modifiedBy)")
