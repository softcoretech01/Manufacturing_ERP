...
class SupplierContactSchema(BaseModel):
    ...
    mobile: str = Field(..., max_length=10, min_length=10, pattern=r'^[0-9]{10}$')
...
class SupplierBaseSchema(BaseModel):
    ...
    gstin: str | None = Field(None, max_length=15, min_length=15)
    gstRegistrationType: str = Field(..., max_length=20)
    pan: str | None = Field(None, max_length=10, min_length=10)
