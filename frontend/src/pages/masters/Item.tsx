...
export function ItemMasterPage() {
  ...
  const columns: Column<Item>[] = [
    ...
    { key: 'name', header: 'Item name', sortable: true, width: '260px', accessor: (i) => i.name, render: (i) => <span className="truncate text-xs text-fg" title={String(i.name ?? "")}>{i.name}</span> },
    ...
    { key: 'category', header: 'Category', width: '200px', sortable: true, render: (i) => <span className="truncate text-xs text-fg-muted" title={String(i.category ?? "")}>{i.category}</span> },
