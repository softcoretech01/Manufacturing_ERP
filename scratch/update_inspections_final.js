...
inspContent = inspContent.replace(/update\(live\.uid,/g, 'inspectionsApi.update(live.id as number,');
inspContent = inspContent.replace(/update\(detail\.uid,/g, 'inspectionsApi.update(detail.id as number,');
